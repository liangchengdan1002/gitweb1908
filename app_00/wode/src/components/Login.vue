<template>
  <div>
     <div class="title">
      <div class="head">
        <img src="../assets/denglu_1.png" alt="">
        <ul class="u1">
          <li><router-link to="" class="rouL">登 录 /</router-link></li>
          <li><router-link to="" class="rouL">注 册</router-link></li>
          <li>＞</li>
        </ul>
        <ul class="u2">
          <li>一</li>
...
.title .head>img{
  ...
  margin-top: 45px;margin-left:53px;
